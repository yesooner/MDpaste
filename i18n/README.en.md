...
2. Download `MDPASTE-portable-v0.1.0.0.zip`.
...
This portable package release is `v0.1.0.0`. It redistributes upstream PasteMD `v0.1.6.8`: <https://github.com/RICHQAQ/PasteMD/tree/v0.1.6.8>
